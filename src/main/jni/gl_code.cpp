...
JNIEXPORT void JNICALL Java_com_nibiru_opengldemo_sample14_sample14_11_GL2JNILib_init
        (JNIEnv *, jclass, jint width, jint height)//调用初始化函数
{
    setupGraphics(width, height);
}

JNIEXPORT void JNICALL Java_com_nibiru_opengldemo_sample14_sample14_11_GL2JNILib_step
        (JNIEnv *, jclass)//调用渲染函数
{
    renderFrame();
}

JNIEXPORT void JNICALL Java_com_nibiru_opengldemo_sample14_sample14_11_GL2JNILib_nativeSetAssetManager
