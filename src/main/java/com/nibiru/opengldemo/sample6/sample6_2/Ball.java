package com.nibiru.opengldemo.sample6.sample6_2;
...
import static com.nibiru.opengldemo.utils.Constant.UNIT_SIZE;
...
public class Ball {
    ...
    public void initShader(MySurfaceView mv) {
        // 加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("sample6_2/vertex.sh", mv.getResources());
        // 加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("sample6_2/frag.sh", mv.getResources());
        // 基于顶点着色器与片元着色器创建程序
