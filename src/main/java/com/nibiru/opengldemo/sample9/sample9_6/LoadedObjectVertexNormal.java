package com.nibiru.opengldemo.sample9.sample9_6;
...
public class LoadedObjectVertexNormal {
    ...
    public void initShader(MySurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("sample9_6/vertex.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("sample9_6/frag.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
