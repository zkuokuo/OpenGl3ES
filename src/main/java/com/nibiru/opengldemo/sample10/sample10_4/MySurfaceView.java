...
class MySurfaceView extends GLSurfaceView {
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //加载要绘制的物体
            ch = LoadUtil.loadFromFileVertexOnlyAverage("sample10_4/ch.obj", MySurfaceView.this.getResources(), MySurfaceView.this);
            cft = LoadUtil.loadFromFileVertexOnlyFace("sample10_4/cft.obj", MySurfaceView.this.getResources(), MySurfaceView.this);
            qt = LoadUtil.loadFromFileVertexOnlyAverage("sample10_4/qt.obj", MySurfaceView.this.getResources(), MySurfaceView.this);
            yh = LoadUtil.loadFromFileVertexOnlyAverage("sample10_4/yh.obj", MySurfaceView.this.getResources(), MySurfaceView.this);
