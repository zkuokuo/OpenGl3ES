...
class MySurfaceView extends GLSurfaceView {
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //纹理id
            rectTexId = BnETC2Util.initTextureETC2("sample10_1b/pkm/lgq.pkm", MySurfaceView.this.getResources());
            //加载要绘制的物体
            ch = LoadUtil.loadFromFileVertexOnlyAverage("sample10_1b/obj/ch.obj", MySurfaceView.this.getResources(), MySurfaceView.this);
            pm = LoadUtil.loadFromFileVertexOnlyFace("sample10_1b/obj/pm.obj", MySurfaceView.this.getResources(), MySurfaceView.this);
            cft = LoadUtil.loadFromFileVertexOnlyFace("sample10_1b/obj/cft.obj", MySurfaceView.this.getResources(), MySurfaceView.this);
            qt = LoadUtil.loadFromFileVertexOnlyAverage("sample10_1b/obj/qt.obj", MySurfaceView.this.getResources(), MySurfaceView.this);
            yh = LoadUtil.loadFromFileVertexOnlyAverage("sample10_1b/obj/yh.obj", MySurfaceView.this.getResources(), MySurfaceView.this);
