package com.nibiru.opengldemo.sample7.sample7_5;
...
public class Moon {
    ...
    public void initShader(MySurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("sample7_5/vertex_moon.sh", mv.getResources());
//        ShaderUtil.checkGlError("==ss==");
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("sample7_5/frag_moon.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
//        ShaderUtil.checkGlError("==ss==");
