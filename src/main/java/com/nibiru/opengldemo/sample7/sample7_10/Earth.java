...
public class Earth  {
    ...
    public void initShader(MySurfaceView mv){ //初始化着色器
        //加载顶点着色器的脚本内容
        mVertexShader= ShaderUtil.loadFromAssetsFile("sample7_10/vertex_moon.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("sample7_10/frag_moon.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
